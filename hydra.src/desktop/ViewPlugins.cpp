...
class TagEditor2Plugin : public desktop::MainPlugin
{
  public:
    ...
    {
      mainwindow->popupWidgetAsDockWidget(new TagEditorView(mainwindow, filelist));
    }
};
...
class ThumbsPlugin : public desktop::MainPlugin
{
  public:
    ...
    virtual void go(desktop::MainWindow *mainwindow, desktop::FileList *filelist)
    {
      mainwindow->popupWidgetAsDockWidget(new ThumbsView(mainwindow, filelist, &mainwindow->mainState().dm_thumbcache, true));
    }
};
...
class ThumbsStripPlugin : public desktop::MainPlugin
{
  public:
    ...
    virtual void go(desktop::MainWindow *mainwindow, desktop::FileList *filelist)
    {
      mainwindow->popupWidgetAsDockWidget(new ThumbsView(mainwindow, filelist, &mainwindow->mainState().dm_thumbcache, false));
    }
};
...
class MainImagePlugin : public desktop::MainPlugin
{
  public:
    ...
    virtual void go(desktop::MainWindow *mainwindow, desktop::FileList *filelist)
    {
      mainwindow->popupWidgetAsDockWidget(new MainImageView(mainwindow, filelist, &mainwindow->mainState().dm_imagecache));
    }
};
...
class MainImageVCRPlugin : public desktop::MainPlugin
{
  public:
    ...
    virtual void go(desktop::MainWindow *mainwindow, desktop::FileList *filelist)
    {
      ...
      lay->addWidget(new MainImageView(mainwindow, filelist, &mainwindow->mainState().dm_imagecache), 1);
