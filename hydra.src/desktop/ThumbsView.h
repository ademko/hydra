...
class desktop::ThumbsView : public desktop::View {
  ...
  public:
     ...
     * Constructor.
     *
     * @param wrap_list if true, there will be wrapping (false = thumbstrip like
     * mode)
     * @param popout_on_activate if nonnull, this MainWindow will be used to
     * popout a new view on activation
     * @author Aleksander Demko
     */
    ThumbsView(MainWindow *mainwin, FileList *_filelist,
