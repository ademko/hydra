...
class SelectAllPlugin : public desktop::MainPlugin {
  public:
    ...
    virtual void go(desktop::MainWindow *mainwindow,
        ...
        filelist->selectionModel()->select(
            QItemSelection(filelist->index(0, 0),
                           filelist->index(filelist->rowCount() - 1,
...
void DeletePlugin::go(desktop::MainWindow *mainwindow,
                      desktop::FileList *filelist) {
    QStringList list;
...
void SelectByTagsPlugin::go(desktop::MainWindow *mainwindow,
                            desktop::FileList *filelist) {
    ...
    while (true) {
        query_string =
            QInputDialog::getText(mainwindow, "Select by Tags",
                                  "Tags:", QLineEdit::Normal, query_string);
