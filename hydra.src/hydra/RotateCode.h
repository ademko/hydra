...
namespace hydra
{
  ...
  /**
   * Converts the given coordinates to the final coordinates, as if it where rotated by the given exif rotation
   * code. Node, the variables can the same (&origW == newW, etc)
   *
   * @author Aleksander Demko
   */ 
  ...
  /**
   * Uses both detectExifRotate and detectTagRotate to come up with a reasonable default.
   * Will never return -1 (will return 0 instead).
   *
   * @author Aleksander Demko
   */ 
