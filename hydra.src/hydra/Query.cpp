...
hydra::WildcardString::WildcardString(const QString &s)
  : QString(s)
{
...
TagToken::TagToken(const QString &tag)
  : dm_tag(tag)
{
}
...
hydra::NotToken::NotToken(shared_ptr<Token> t)
  : dm_tok(t)
{
}
...
bool hydra::parseQueryTokens(const QString &s, std::shared_ptr<hydra::Token> &tok)
{
